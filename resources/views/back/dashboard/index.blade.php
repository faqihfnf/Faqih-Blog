...
@section('content') {{-- ! isi dari section harus sesuai dengan yang ada di @yield yang ada di folder back->layout->template --}}
                      ...
                      @foreach($latest_article as $item )
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="{{url('articles/'.$item->id)}}" class="btn btn-sm btn-secondary"><i class="bi bi-journals" title="Detail"></i></a>
                          </td>
                        </tr>
                      @endforeach
                    </tbody>
